import { YamlObject, LayoutObject, YamlMetaObject } from "../utils/yaml-parser";
...
export type YamlParserWorkerResponseData =
    ...
    | { type: YamlParserWorkerResponseType.ClosestObject; object: YamlMetaObject; page?: LayoutObject }
